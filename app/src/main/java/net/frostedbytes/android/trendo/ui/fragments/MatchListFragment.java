...
public class MatchListFragment extends Fragment {
  ...
  private ArrayList<MatchSummaryEntity> mMatchSummaries;
  private String mTeamId;

  public static MatchListFragment newInstance(ArrayList<MatchSummaryEntity> matchSummaries, String teamId) {
  ...
  public void onAttach(Context context) {
    ...
    if (arguments != null) {
      mMatchSummaries = (ArrayList<MatchSummaryEntity>)arguments.getSerializable(BaseActivity.ARG_MATCH_SUMMARIES);
  ...
  private class MatchSummaryAdapter extends RecyclerView.Adapter<MatchSummaryHolder> {
    ...
    private final List<MatchSummaryEntity> mMatchSummaries;

    MatchSummaryAdapter(List<MatchSummaryEntity> matchSummaries) {
    ...
    public void onBindViewHolder(@NonNull MatchSummaryHolder holder, int position) {
      ...
      MatchSummaryEntity matchSummary = mMatchSummaries.get(position);
  ...
  private class MatchSummaryHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private MatchSummaryEntity mMatchSummary;
    ...
    void bind(MatchSummaryEntity matchSummary) {
...
//                    mMatchSummary.AwayFullName));
      mMatchDateTextView.setText(mMatchSummary.MatchDate);
