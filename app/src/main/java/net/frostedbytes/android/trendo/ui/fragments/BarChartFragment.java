...
public class BarChartFragment extends Fragment {
  ...
  public static BarChartFragment newInstance(TrendEntity trend, TrendEntity compare) {

    Log.d(TAG, "++newInstance(Trend, Trend, MatchSummary)");
