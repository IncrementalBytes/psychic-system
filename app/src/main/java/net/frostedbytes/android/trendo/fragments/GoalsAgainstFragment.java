...
public class GoalsAgainstFragment extends Fragment {

  private static final String TAG = "GoalsAgainstFragment";

  static final String ARG_TREND_ID = "trend_id";

  public static final String DisplayName = "Goals Against";

  public static GoalsAgainstFragment newInstance(List<Long> dataPoints) {

    Log.d(TAG, "++newInstance(List<Long>)");
    GoalsAgainstFragment fragment = new GoalsAgainstFragment();
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    View view = inflater.inflate(R.layout.fragment_goals_against, container, false);
    LineChart chart = view.findViewById(R.id.trend_chart_goals_against);
