...
public class GoalDifferentialFragment extends Fragment {

  private static final String TAG = "GoalDifferentialFragment";

  static final String ARG_TREND_ID = "trend_id";

  public static final String DisplayName = "Goal Differential";

  public static GoalDifferentialFragment newInstance(List<Long> dataPoints) {

    Log.d(TAG, "++newInstance(List<Long>)");
    GoalDifferentialFragment fragment = new GoalDifferentialFragment();
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    View view = inflater.inflate(R.layout.fragment_goal_differential, container, false);
    LineChart chart = view.findViewById(R.id.trend_chart_goal_differential);
